...
#define ORIGINAL_FILE_NAME "UE4Editor-Project_Delve-Win64-DebugGame.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 1
#define UE_PROJECT_NAME Project_Delve
#define DEPRECATED_FORGAME DEPRECATED
#define PROJECT_DELVE_API DLLEXPORT
